    ...
    <section className="relative pt-20 pb-16 px-4 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto flex flex-col items-center">
        ...
        <p className="text-xl max-w-3xl text-center mb-10 text-gray-700">
          Consultoria personalizada para iniciantes e investidores. Responda algumas perguntas e receba orientação especializada diretamente no seu Telegram.
        </p>
        ...
        <div className="mt-16 relative w-full max-w-3xl">
          ...
          <div className="absolute top-10 right-20 w-14 h-14 animate-float" style={{ animationDelay: "1s" }}>
            <img src="https://cryptologos.cc/logos/ethereum-eth-logo.png" alt="Ethereum" className="w-full h-full object-contain" />
          </div>
          <div className="absolute -bottom-4 left-1/4 w-12 h-12 animate-float" style={{ animationDelay: "1.5s" }}>
            <img src="https://cryptologos.cc/logos/cardano-ada-logo.png" alt="Cardano" className="w-full h-full object-contain" />
          </div>
        </div>
      </div>
    </section>
